...
var args40227 = [];
var len__27054__auto___40233 = arguments.length;
var i__27055__auto___40234 = (0);
while(true){
if((i__27055__auto___40234 < len__27054__auto___40233)){
args40227.push((arguments[i__27055__auto___40234]));

var G__40235 = (i__27055__auto___40234 + (1));
i__27055__auto___40234 = G__40235;
continue;
} else {
}
break;
...
if(typeof devtools.toolbox.t_devtools$toolbox40230 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox40230 = (function (obj,header,style,tag,meta40231){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox40230.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_40232,meta40231__$1){
var self__ = this;
var _40232__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox40230(self__.obj,self__.header,self__.style,self__.tag,meta40231__$1));
});

devtools.toolbox.t_devtools$toolbox40230.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_40232){
var self__ = this;
var _40232__$1 = this;
return self__.meta40231;
});

devtools.toolbox.t_devtools$toolbox40230.prototype.devtools$protocols$IFormat$ = true;

devtools.toolbox.t_devtools$toolbox40230.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox40230.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox40230.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox40230.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta40231","meta40231",1682877105,null)], null);
});

devtools.toolbox.t_devtools$toolbox40230.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox40230.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox40230";

devtools.toolbox.t_devtools$toolbox40230.cljs$lang$ctorPrWriter = (function (this__26585__auto__,writer__26586__auto__,opt__26587__auto__){
return cljs.core._write.call(null,writer__26586__auto__,"devtools.toolbox/t_devtools$toolbox40230");
});

devtools.toolbox.__GT_t_devtools$toolbox40230 = (function devtools$toolbox$__GT_t_devtools$toolbox40230(obj__$1,header__$1,style__$1,tag__$1,meta40231){
return (new devtools.toolbox.t_devtools$toolbox40230(obj__$1,header__$1,style__$1,tag__$1,meta40231));
});

}

return (new devtools.toolbox.t_devtools$toolbox40230(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1499781174475