...
return cljs.core.reduce.call(null,(function (result,p__39428){
...
var vec__39435 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__39435,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__39435,(1),null);
var ab = cljs.core.nth.call(null,vec__39435,(2),null);
...
var args39438 = [];
var len__27054__auto___39441 = arguments.length;
var i__27055__auto___39442 = (0);
while(true){
if((i__27055__auto___39442 < len__27054__auto___39441)){
args39438.push((arguments[i__27055__auto___39442]));

var G__39443 = (i__27055__auto___39442 + (1));
i__27055__auto___39442 = G__39443;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args39438.length)].join('')));
...
return (function (){var G__39448 = (((clojure.data.equality_partition.call(null,a) instanceof cljs.core.Keyword))?clojure.data.equality_partition.call(null,a).fqn:null);
switch (G__39448) {
case "atom":
...
//# sourceMappingURL=data.js.map?rel=1499781173017