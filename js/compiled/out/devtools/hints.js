...
var map__40499 = top_item;
var map__40499__$1 = ((((!((map__40499 == null)))?((((map__40499.cljs$lang$protocol_mask$partition0$ & (64))) || (map__40499.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__40499):map__40499);
var file = cljs.core.get.call(null,map__40499__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__40499__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__40499__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e40498){var _e = e40498;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___40501 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___40501)){
var seen_errors_40502 = temp__4655__auto___40501;
if(cljs.core.truth_(seen_errors_40502.has(self))){
} else {
seen_errors_40502.add(self);

var temp__4657__auto___40503 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___40503)){
var sense_40504 = temp__4657__auto___40503;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_40504)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1499781174838