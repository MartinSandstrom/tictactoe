...
var G__39686 = devtools.prefs.pref.call(null,v);
v = G__39686;
continue;
} else {
return v;
...
}catch (e39699){var e__37091__auto__ = e39699;
return false;
}})();
...
}catch (e39703){var e__37091__auto__ = e39703;
return false;
}})();
...
}catch (e39705){var e__37091__auto__ = e39705;
return false;
}}
}
});
...
var vec__39710 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__39710,(0),null);
var name = cljs.core.nth.call(null,vec__39710,(1),null);
...
return cljs.core.some.call(null,(function (p1__39713_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__39713_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1499781173505